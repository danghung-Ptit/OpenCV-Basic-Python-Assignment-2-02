...
def main():
	path = "/Users/abc/Documents/Code_doAn/YOLOv5/data_test/0B18DCDT100BS.png"
	Resize_basewidth(300, path)  # nếu đổi size 1 ảnh thì gọi hàm Resize_hsize hoặc Resize_basewidth
